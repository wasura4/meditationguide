    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-[var(--background)]">
            ...
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgba(0, 199, 190, 0.1)' }}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
          <div className="health-card text-center mb-8">
            <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: 'rgba(0, 199, 190, 0.1)' }}>
              <svg className="w-10 h-10" style={{ color: 'var(--ring-stand)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
        ...
        {/* Main Content */}
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 lg:pb-12">
          <div className="min-h-[600px]">
            {activeTab === 'library' ? (
              <DhammaContentLibrary />
            ) : (
              <div className="health-card text-center py-20">
                <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: 'rgba(88, 86, 214, 0.1)' }}>
                  <svg className="w-10 h-10 text-[var(--secondary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                  </svg>
                </div>
                <h3 className="text-xl lg:text-2xl font-bold text-[var(--foreground)] mb-3">No favorites yet</h3>
          ...
          <div className="mt-10 health-card">
            <h3 className="text-xl lg:text-2xl font-bold text-[var(--foreground)] mb-4">
