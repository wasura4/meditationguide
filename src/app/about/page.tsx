          ...
          <div className="bg-card rounded-2xl p-8 shadow-sm border space-y-6">
            <div className="prose prose-lg max-w-none">
              <div className="text-foreground leading-relaxed space-y-6" style={{ fontSize: '1.125rem', lineHeight: '1.8' }}>
                ...
                <p>
                  විශේෂයෙන්ම පූජ්‍ය පෝරුවදන්ඩේ සිරිවංශ ස්වාමින්වහන්සේ මෙම කර්මස්ථාන දේශනා අප වෙත මෙත් සිතින් යුතුව ලබා දී සිදු කරගත් අප්‍රමාණ වූ කුසලය උන්වහන්සේ පතන්නාවූ බෝධියෙන් උතුම් නිර්වාණයට පැමිණෙත්වායි නිරතුරුව සිහි කරමු! අප සැමට නිරතුරුවම උපදෙස් ලබාදෙන පූජ්‍ය ආටිගල විපස්සී ස්වාමින්වහන්සේ හටත් මෙම ධර්ම දානය උන්වහන්සේ පතන්නාවූ උතුම් බෝධියට මෙම කුසලය හේතු වේවායි පතමි.
                </p>
